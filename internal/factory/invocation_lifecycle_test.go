...
func TestGatherLaunchPerformsNoMutation(t *testing.T) {
	...
	module := newInvocationLifecycle(nil, nil, nil, nil, nil, nil, nil, invocationLifecycleHooks{})
...
func TestGatherReviewLaunchReadsGatesAndWorktreeWithoutMutation(t *testing.T) {
	...
	module := newInvocationLifecycle(nil, nil, nil, nil, nil, worktree, nil, invocationLifecycleHooks{})
