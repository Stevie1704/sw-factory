...
func TestAllEmbeddedPromptVersionsHaveStableContentIdentity(t *testing.T) {
	tests := []struct {
		...
		{name: "architecture v2", role: workflow.RoleArchitecture, stage: string(workflow.StageArchitecture), version: workflow.PromptVersionArchitecture, sha256: "821ca4fbf26c1c914a14730ca6d1856d7c1c655c27201294a7aaae0362aae0cb"},
