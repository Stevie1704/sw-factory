...
func TestAllEmbeddedPromptVersionsHaveStableContentIdentity(t *testing.T) {
	tests := []struct {
		...
		{name: "implementation v2", role: workflow.RoleImplementation, stage: string(store.StageImplementation), version: workflow.PromptVersionImplementation, sha256: "658c12098f707a3f400197802747e29b7665428bd00e6f3dd1fe4f0b2923a439"},
		...
		{name: "architecture v1", role: workflow.RoleArchitecture, stage: string(workflow.StageArchitecture), version: workflow.PromptVersionArchitecture, sha256: "03efc454fd338fdb007244f439d92adb963eaca872d3f024df2ab3c0b970a5d2"},
