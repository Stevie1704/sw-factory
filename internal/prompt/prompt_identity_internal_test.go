...
func TestAllEmbeddedPromptVersionsHaveStableContentIdentity(t *testing.T) {
	tests := []struct {
		...
		{name: "implementation v9", role: workflow.RoleImplementation, stage: string(store.StageImplementation), version: workflow.PromptVersionImplementation, sha256: "e0a6f046876022c8095a3bc161127e2b6ec0518ef51bbc57f0a753fb8a0ca998"},
		{name: "implementation v8", role: workflow.RoleImplementation, stage: string(store.StageImplementation), version: "implementation-v8", sha256: "1a7d302191e1f3e34de34046b188db5ae1c191be986e4ad40327e5932bd01cdd"},
		...
		{name: "specification review v8", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: workflow.PromptVersionSpecificationReview, sha256: "9f07951a1a8ef748f8e4ef01032383b3191376fa5a321d8f460d425d8d7990a8"},
		{name: "specification review v7", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: "specification-review-v7", sha256: "f127acc9fa3ad7d8c31a2944a418f601a9b6185f06fd7214eff3a4d30a16e318"},
		{name: "specification review v6", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: "specification-review-v6", sha256: "6ae0e5d82480384e8c6bfb3bdc4e3f2c66b37f71f5501abf77029b53da07ad88"},
		{name: "specification review v5", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: "specification-review-v5", sha256: "b8f39cd13be19fbb71878f30bd8354a64e28a766e557b5e967f643a4974ce3e5"},
		{name: "specification review v4", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: "specification-review-v4", sha256: "164dc97b4cb7250391158537b4f931c151df6eede866e8ce9b139b49dc067773"},
		{name: "specification review v3", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: "specification-review-v3", sha256: "ea66e87d7f144bbc12c63ba2a2d6bb40c05aaef7112cb12d7cb626c858f2c204"},
		...
		{name: "standards review v8", role: workflow.RoleStandardsReview, stage: string(workflow.StageStandardsReview), version: workflow.PromptVersionStandardsReview, sha256: "b55ea69e303fbbde83931681a7fb2691849030afe43e975e4f57c69f87f731a0"},
		{name: "standards review v7", role: workflow.RoleStandardsReview, stage: string(workflow.StageStandardsReview), version: "standards-review-v7", sha256: "b773948d204ff17301cde3663a8d449deef6a904560bc4dbdd9dd9f324457dcd"},
		{name: "standards review v6", role: workflow.RoleStandardsReview, stage: string(workflow.StageStandardsReview), version: "standards-review-v6", sha256: "2f8bb85f4e36cbd23a9894bfdd5ea5f9c815bb87df49a074f90c95a4bdc05469"},
		{name: "standards review v5", role: workflow.RoleStandardsReview, stage: string(workflow.StageStandardsReview), version: "standards-review-v5", sha256: "f6c848e43eba598767911ba91e73b9372bd2c82d2a9d0729f79ec7e6a6a6fddb"},
		{name: "standards review v4", role: workflow.RoleStandardsReview, stage: string(workflow.StageStandardsReview), version: "standards-review-v4", sha256: "007370ac417296565ab8c5ae6e009e6a39591c2a0122acb669f348ceaef9bebb"},
