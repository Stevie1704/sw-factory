...
func TestAllEmbeddedPromptVersionsHaveStableContentIdentity(t *testing.T) {
	tests := []struct {
		...
		{name: "specification review v7", role: workflow.RoleSpecificationReview, stage: string(store.StageReview), version: workflow.PromptVersionSpecificationReview, sha256: "f127acc9fa3ad7d8c31a2944a418f601a9b6185f06fd7214eff3a4d30a16e318"},
		...
		{name: "standards review v7", role: workflow.RoleStandardsReview, stage: string(workflow.StageStandardsReview), version: workflow.PromptVersionStandardsReview, sha256: "b773948d204ff17301cde3663a8d449deef6a904560bc4dbdd9dd9f324457dcd"},
